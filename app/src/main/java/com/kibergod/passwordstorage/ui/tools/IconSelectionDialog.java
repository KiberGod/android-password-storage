...
public class IconSelectionDialog {
    ...
    public static void showIconSelectionDialog(Context context, int fontSize, Consumer<String> func) {
        ...
        FontUtils.setFontSizeToView(context, dialogView, R.id.iconWindowTextView, fontSize);
        ...
        for (int set = 0; set < iconSetIds.length; set++) {
            ...
            FontUtils.setFontSizeToView(context, iconsTitleView, R.id.iconsGroupName, fontSize);
