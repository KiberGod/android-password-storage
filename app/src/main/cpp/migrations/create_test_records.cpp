...
void create_test_records::runMigrations() {
    ...
    insert("12234", "йцукен123", NULL);
    insert("запис", "текст", 1);
    insert("MAIN PASS", "MY MAIN PASS: 1111", 2);
    insert("site", "loooooooooooooooooooooooooooooong teeeeeeeeeeeeext", 0);

    insert("privat","123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890",NULL);
    ...
    insert("стім", "код підтвердження: 1111999222", NULL);
